...
//      blah
// =====================================================================================
static void SetModelNumbers( void )
{
	int	i, j, models = 1;
	char	value[10];
...
static void SetLightStyles( void )
{
	...
	for( int i = 1; i < g_numentities; i++ )
	{
		...
		if (IntForKey( e, "_sky" ) || !strcmp( t, "light_environment" ))
		{
			safe_snprintf( value, sizeof( value ), "%i", LM_ENVIRONMENT_STYLE );
			SetKeyValue( e, "style", value );
			continue;
		}
#endif
...
//  ConvertHintToEmtpy
// =====================================================================================
static void ConvertHintToEmpty( void )
{
