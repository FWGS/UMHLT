...
#ifdef VERSION_32BIT
#define PLATFORM_VERSIONSTRING "windows-32"
#define PLATFORM_CAN_CALC_EXTENT
#endif
#ifdef VERSION_64BIT
#ifdef VERSION_LINUX
#define PLATFORM_VERSIONSTRING "linux-64"
#else
#define PLATFORM_VERSIONSTRING "windows-64"
#endif
#define PLATFORM_CAN_CALC_EXTENT
#elif defined VERSION_LINUX
#define PLATFORM_VERSIONSTRING "linux-32"
#define PLATFORM_CAN_CALC_EXTENT
#endif
#ifdef VERSION_OTHER
...
#define HLRAD_VISMATRIX_NOMARKSURFACES //--vluzacn
	#endif
#ifndef ZHLT_TRANSLUCENT_WORLD_WATER
