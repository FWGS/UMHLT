...
typedef enum
{
	...
	// qcsg
	assume_MISSING_START_BRACKET_IN_TEXTUREDEF_U,
	assume_MISSING_END_BRACKET_IN_TEXTUREDEF_U,
	assume_MISSING_START_BRACKET_IN_TEXTUREDEF_V,
	assume_MISSING_END_BRACKET_IN_TEXTUREDEF_V,
